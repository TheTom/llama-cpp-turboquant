...
struct ggml_metal_pipeline_with_params ggml_metal_library_get_pipeline_set_rows_chrono   (ggml_metal_library_t lib, enum ggml_type tdst, enum ggml_type tidx);
