...
#define IM2COL(bda) \
    ...
    // TurboQuant WHT
    ggml_vk_create_pipeline(device, device->pipeline_turbo_wht, "turbo_wht", turbo_wht_len, turbo_wht_data, "main", 2,
                            3 * sizeof(uint32_t), { 128, 1, 1 }, {}, 1);
...
static void ggml_vk_turbo_wht(ggml_backend_vk_context * ctx,
                              vk_context &              subctx,
