...
GGML_API void dequantize_row_q2_preh(const block_q2_preh * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_q2_preh_ref(const float * GGML_RESTRICT x, block_q2_preh * GGML_RESTRICT y, int64_t k);
