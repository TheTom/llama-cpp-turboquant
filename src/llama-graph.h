...
struct llm_graph_context {
    ...
    ggml_tensor * build_lora_mm(ggml_tensor * w, ggml_tensor * cur, ggml_tensor * w_s = nullptr) const;
    ...
    llm_graph_qkv build_qkv(const llama_layer & layer,
                            ggml_tensor *       cur,
                            int64_t             n_embd_head,
                            int64_t             n_head,
                            int64_t             n_head_kv,
    ...
    void build_pooling(ggml_tensor * cls,
                       ggml_tensor * cls_b,
                       ggml_tensor * cls_out,
    ...
    void build_dense_out(ggml_tensor * dense_2, ggml_tensor * dense_2_b, ggml_tensor * dense_3) const;
};
