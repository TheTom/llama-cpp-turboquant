...
llama_context * llama_init_from_model(
    ...
    // ChronoQuant's current llama.cpp prototype is a write-time F16/F32 KV reconstruction path.
    // The user sets CHRONO_STRIDE_K / CHRONO_STRIDE_V env vars to enable it.
