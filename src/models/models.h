...
struct llm_build_delta_net_base : public llm_graph_context {
    ...
    std::pair<ggml_tensor *, ggml_tensor *> build_delta_net_chunking(ggml_tensor * q,
                                                                     ggml_tensor * k,
                                                                     ggml_tensor * v,
                                                                     ggml_tensor * g,
                                                                     ggml_tensor * b,
    ...
    // returns pair of output and new state
    std::pair<ggml_tensor *, ggml_tensor *> build_delta_net_autoregressive(ggml_tensor * q,
                                                                           ggml_tensor * k,
                                                                           ggml_tensor * v,
                                                                           ggml_tensor * g,
                                                                           ggml_tensor * b,
    ...
    std::pair<ggml_tensor *, ggml_tensor *> build_delta_net_fused(ggml_tensor * q,
                                                                  ggml_tensor * k,
                                                                  ggml_tensor * v,
                                                                  ggml_tensor * g,
                                                                  ggml_tensor * b,
    ...
    std::pair<ggml_tensor *, ggml_tensor *> build_delta_net(ggml_tensor * q,
                                                            ggml_tensor * k,
                                                            ggml_tensor * v,
                                                            ggml_tensor * g,
                                                            ggml_tensor * b,
    ...
    ggml_tensor * build_conv_state(llm_graph_input_rs * inp,
    ...
    ggml_tensor * build_recurrent_attn(llm_graph_input_rs * inp,
...
struct llama_model_llama : public llama_model_base {
    ...
    template <bool embed> struct graph : public llm_graph_context {
...
struct llama_model_llama4 : public llama_model_base {
    ...
    template <bool iswa> struct graph : public llm_graph_context {
        graph(const llama_model & model, const llm_graph_params & params);
    };
...
struct llama_model_llama_embed : public llama_model_llama {
    ...
    template <bool embed> using graph = llama_model_llama::graph<embed>;
...
struct llama_model_phimoe : public llama_model_base {
    ...
    template <bool iswa> using graph = llama_model_phi3::graph<iswa>;
...
struct llama_model_t5 : public llama_model_base {
    ...
    template <bool is_enc> struct graph : public llm_graph_context {
        graph(const llama_model & model, const llm_graph_params & params);
    };
...
struct llama_model_lfm2moe : public llama_model_base {
    ...
    template <bool iswa> using graph = llama_model_lfm2::graph<iswa>;
...
struct llama_model_kimi_linear : public llama_model_base {
    ...
    struct graph : public llm_build_delta_net_base {
        ...
        std::pair<ggml_tensor *, ggml_tensor *> build_kda_autoregressive(ggml_tensor * q,
                                                                         ggml_tensor * k,
                                                                         ggml_tensor * v,
                                                                         ggml_tensor * gk,
                                                                         ggml_tensor * beta,
        ...
        std::pair<ggml_tensor *, ggml_tensor *> build_kda_chunking(ggml_tensor * q,
                                                                   ggml_tensor * k,
                                                                   ggml_tensor * v,
                                                                   ggml_tensor * gk,
                                                                   ggml_tensor * beta,
